...
Visit the API Reference to learn how to implement Image Moderation AI in your projects. Get access to Sample
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/content-moderation/image-moderation">
  Visit the API Reference to learn how to implement Image Moderation AI in your projects. Get
  access to
