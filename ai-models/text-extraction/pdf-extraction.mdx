...
Visit the API Reference to learn how to implement PDF Extraction in your projects. Get access to
Sample
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/text-extraction/pdf-extraction">
