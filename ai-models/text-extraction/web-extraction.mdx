...
Visit the API Reference to learn how to implement SpeechAI in your projects. Get access to Sample
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/speech-extraction">
  Visit the API Reference to learn how to implement SpeechAI in your projects. Get access to
